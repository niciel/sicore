...
public class EditorChatFloat extends IChatEditor<Float> {
    ...
    @Override
    public void enable(WeakReference<ChatCommandEditor> editor, String name, String description, Class type, Ref<Float> refToObject) {
        this.ref = refToObject;
        this.name = name;
        WeakReference<Ref<Float>>  _ref = new WeakReference<>(ref);
